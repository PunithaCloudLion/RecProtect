if(row.Boat_Model_Year != null)
	{
		...
		if(yearsBetween > 15)
		{
			...
			row.Referral_Boat_Model_Year=true;
			...
			row.Referral_Replacement_cost=null;
		}
		else
		{
			row.Referral_Boat_Model_Year=false;
			...
			row.Override_Boat_for_being_more_than_15_years_old="";
