...
if(row.Select_coverage_for_policy == "Current Market Value Coverage")
	...
	//Commemnted by Ananth 07/04
	/*if(row.Actual_Cash_Value != null)
	{
		// 	if(row.Actual_Cash_Value < 10000)
		// 	{
		// 		alert "Your unit's value must be greater than $10,000";
		// 	}
		//----------------Api Call to Send Coverage Details For Trailer Server-----------
		//trailerpost = thisapp.Server_Side.Latest_TrailerPremiumCoverage_Details(input.ID);
