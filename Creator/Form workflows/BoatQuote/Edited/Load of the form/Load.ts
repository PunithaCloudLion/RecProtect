...
//
//alert "custo----" + input.Customer_ID.First_Name ;
// if(input.Are_there_any_additional_names_on_the_boat_ownership1 == true)
// {
// 	show Additional_Names;
// }
...
{
	fetchProvince = input.Please_select_the_province_your_boat_is_used_in;
}
else
{
	fetchProvince = "";
}
input.Please_select_the_province_your_boat_is_used_in = fetchProvince;
// else 
// {
